...
const PC_FIELDS := [
	...
	["@", "─ 일섬 ─"],
	["slash_base_damage", "일섬 기본 데미지", "일섬이 잡몹에 주는 기본 데미지(자연수). 몹 HP 와 함께 밸런싱. 보스는 별도(boss_slash_damage).", "i"],
	...
	["sheathe_cooldown", "납도 쿨타임", "납도(RB) 후 다음 납도까지 대기 시간(초). 거합 추격 윈도우는 무시. 낮을수록 자주 거둠.", "f"],
	["sheathe_range", "납도 사거리", "납도 정산 반경(유닛). 이 안의 표식 적만 거둔다. 클수록 넓게 회수.", "f"],
	["sheathe_dmg", "납도 단가", "납도 미만 표식 단가(자연수). 미만/보스 적에 표식수×이 값 피해. 만개 처형은 무관.", "i"],
